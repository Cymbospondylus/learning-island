...
import site.bzyl.bitstore.domain.enums.UserStatusEnum;
import site.bzyl.bitstore.event.UserEvent;
import site.bzyl.bitstore.service.AuthenticationService;
import site.bzyl.bitstore.service.MessageService;
import site.bzyl.bitstore.service.UserEventLogService;
...
import site.bzyl.bitstore.viewmodel.student.user.*;
...
public class UserController extends BaseApiController {
    ...
    public RestResponse register(@RequestBody @Valid UserRegisterVM model) {
        ...
        userEventLog.setContent("欢迎 " + user.getUserName() + " 注册来到比特商店在线学习系统");
